...
if (isset($_POST['changePassword'])) {
    changeMyPassword('professores');
}
?>

<nav class="sb-topnav navbar navbar-expand navbar-dark bg-navy">
    <a class="navbar-brand" href="index.php">Exame Sem-Automático</a>
    <button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button>

    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
        <div class="dropdown">
            <div class="input-group">
                <input type="text" class="form-control " name="pesquisa_aluno" id="pesquisa_aluno" placeholder="Pesquisar alunos..." autocomplete="off">
